...
getSearchTest :: Int -> Int -> String
getSearchTest n i = "testAuto" ++ show i ++ "size" ++ show n ++
  ...
  where
    ...
    graph = unsafePerformIO . generate $ adjGen (n > 20) n
    showSols :: String
...
getAllTests :: [String]
getAllTests = fmap (getSearchTest 10) [0..9]
  ++ fmap (getSearchTest 20) [0..9]
  ++ fmap (getSearchTest 30) [0..9]
  ++ fmap (getSearchTest 50) [0..9]
